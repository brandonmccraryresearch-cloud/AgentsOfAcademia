...
- **Files:** `84.0IRH.md` — lines 38, 5750, 7876, 7883, 7948, 8125
...
- **Files:** `84.0IRH.md` — lines 4042, 7878, 7887, 7900, 7928, 7950
...
- **Files:** `scripts/d4_uniqueness.py`, `84.0IRH.md` (§AA.8, §II.3.2, any section claiming isotropy uniqueness)
...
- **Files:** `scripts/higgs_quartic.py`, `84.0IRH.md` §C.5
...
- **Files:** `scripts/ward_identity_closure.py`, `scripts/bz_integral.py`, `84.0IRH.md` §C.1
...
- **Files:** `scripts/ckm_triality.py`, `84.0IRH.md` §C.3
...
- **Files:** `scripts/two_loop_unification.py`, `84.0IRH.md` §C.4, §IV.5
...
- **Files:** `84.0IRH.md` — lines 7883, 7884, 7948
...
- **Files:** `84.0IRH.md` — lines 7900, 7928
...
- **Files:** New script `scripts/lattice_g_minus_2.py`, `84.0IRH.md` §C.7
...
- **Files:** New script `scripts/cosmological_constant_spectral.py`, `84.0IRH.md`
...
- **Files:** New script `scripts/higgs_vev_derivation.py`, `84.0IRH.md`
